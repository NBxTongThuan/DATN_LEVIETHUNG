    ...
    public void sendMailRegister() {
        while (!emailQueueRegister.isEmpty()) {
            ...
            try {
                ...
                helper.setSubject("SOLAR LÊ HÙNG XIN CHÂN THÀNH CẢM ƠN QUÝ KHÁCH HÀNG ĐÃ ĐĂNG KÝ TÀI KHOẢN");
    ...
    public void sendMailCreateOrder() {
        while (!emailQueueOrder.isEmpty()) {
            ...
            try {
                ...
                helper.setSubject("SOLAR LÊ HÙNG XIN CHÂN THÀNH CẢM ƠN QUÝ KHÁCH HÀNG ĐÃ MUA HÀNG");
    ...
    public void sendMailForgot() {
        while (!emailQueueForgot.isEmpty()) {
            ...
            try {
                ...
                helper.setSubject("SOLAR LÊ HÙNG - XÁC NHẬN OTP");
        ...
        while (!emailQueueNotice.isEmpty()) {
            ...
            for (Users customer : customers) {
                try {
                    ...
                    helper.setSubject("SOLAR LÊ HÙNG - MÃ GIẢM GIÁ MỚI");
    ...
    public void sendMailConfirmOrder() {
        while (!emailQueueConfirmOder.isEmpty()) {
            ...
            try {
                ...
                helper.setSubject("SOLAR LÊ HÙNG - XÁC NHẬN ĐƠN HÀNG THÀNH CÔNG");
    ...
    public void sendMailReceiveOrder() {
        while (!emailQueueReceiveOder.isEmpty()) {
            ...
            try {
                ...
                helper.setSubject("SOLAR LÊ HÙNG - ĐƠN HÀNG " + orders.getId() + " ĐÃ ĐƯỢC GIAO THÀNH CÔNG !");
    ...
    public void sendMailCancelOrder() {
        while (!emailQueueCancelOder.isEmpty()) {
            ...
            try {
                ...
                helper.setSubject("SOLAR LÊ HÙNG - ĐƠN HÀNG " + orders.getId() + " ĐÃ ĐƯỢC HUỶ THÀNH CÔNG !");
    ...
    public void sendMailCancelOrderByCustomer() {
        while (!emailQueueCancelOderCustomer.isEmpty()) {
            ...
            try {
                ...
                helper.setSubject("SOLAR LÊ HÙNG - ĐƠN HÀNG " + orders.getId() + " ĐÃ ĐƯỢC HUỶ THÀNH CÔNG. Lí do " + orders.getOrderNote());
                sender.send(message);
            } catch (Exception e) {
                throw new RuntimeException(e);
            }
